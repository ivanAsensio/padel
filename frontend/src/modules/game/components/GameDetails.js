...
const GameDetails = () => {
    ...
    const showAddButton = (!userRole && gameObtained && !userOnUserList && gameObtained.users.length < 3) ? ((new Date(gameObtained.millisInitDate)) > today) : false
            ...
            <div className="container bootstrap snippet text-center bg-light">
                    <div className="d-flex">
                        ...
                        {userRole &&
                            ...
                            {!userRole && gameObtained.typeGame !== "Pro" && gameObtained.users.length === 0 &&
                                <div>
                                    <form onSubmit={e => handleRentField(e)}>
                                        <button type="submit" className="btn btn-primary">
                                            <FormattedMessage id="project.global.buttons.rentFullField"/> 
                                        </button>
                                    </form>
                                </div>    
                            }                
